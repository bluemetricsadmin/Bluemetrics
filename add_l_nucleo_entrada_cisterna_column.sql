-- Migracion para agregar columna l_nucleo_entrada_cisterna a tablas de agua
...
ADD COLUMN IF NOT EXISTS l_nucleo_entrada_cisterna NUMERIC(15, 3);
...
WHERE table_schema = 'public'
  ...
  AND column_name = 'l_nucleo_entrada_cisterna'
ORDER BY table_name;
