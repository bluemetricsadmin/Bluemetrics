-- Tabla para registrar el CONSUMO semanal de agua del año 2026
...
CREATE INDEX idx_Lecturas_Semana_Agua_consumo_2026_numero ON public.Lecturas_Semana_Agua_consumo_2026(L_numero_semana);
CREATE INDEX idx_Lecturas_Semana_Agua_consumo_2026_fechas ON public.Lecturas_Semana_Agua_consumo_2026(L_fecha_inicio, L_fecha_fin);

CREATE OR REPLACE FUNCTION update_Lecturas_Semana_Agua_consumo_2026_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER trigger_update_Lecturas_Semana_Agua_consumo_2026_updated_at
    BEFORE UPDATE ON public.Lecturas_Semana_Agua_consumo_2026
    FOR EACH ROW
    EXECUTE FUNCTION update_Lecturas_Semana_Agua_consumo_2026_updated_at();
