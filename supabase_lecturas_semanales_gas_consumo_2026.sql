-- Tabla para el CONSUMO semanal de gas del año 2026
...
CREATE INDEX IF NOT EXISTS idx_lecturas_gas_consumo_2026_numero_semana ON public.lecturas_semanales_gas_consumo_2026(numero_semana);
CREATE INDEX IF NOT EXISTS idx_lecturas_gas_consumo_2026_fecha_inicio ON public.lecturas_semanales_gas_consumo_2026(fecha_inicio);
CREATE INDEX IF NOT EXISTS idx_lecturas_gas_consumo_2026_fecha_fin ON public.lecturas_semanales_gas_consumo_2026(fecha_fin);

-- Crear trigger para actualizar updated_at automáticamente
CREATE OR REPLACE FUNCTION update_lecturas_gas_consumo_2026_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER trigger_update_lecturas_gas_consumo_2026_updated_at
    BEFORE UPDATE ON public.lecturas_semanales_gas_consumo_2026
    FOR EACH ROW
    EXECUTE FUNCTION update_lecturas_gas_consumo_2026_updated_at();
