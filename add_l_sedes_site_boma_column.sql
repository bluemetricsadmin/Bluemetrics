-- Migracion para agregar columna l_sedes_site_boma a tablas de agua
...
ADD COLUMN IF NOT EXISTS l_sedes_site_boma NUMERIC(15, 3);
...
WHERE table_schema = 'public'
  ...
  AND column_name = 'l_sedes_site_boma'
ORDER BY table_name;
